const translations = {
  tr: {
    ...
    modalDescPac: 'Diğer cihazlarda <strong>Otomatik (PAC)</strong> kullanın: Uygulama kapalıyken de internet kesilmez.',
    modalPacQrHint: 'Bu QR\'ı telefonla tarayın; açılan kurulum sayfasında "Kopyala" ile adresi alıp Wi-Fi → Proxy → Otomatik URL\'ye yapıştırın.',
  ...
  en: {
    ...
    modalDescPac: 'Use <strong>Automatic (PAC)</strong> on other devices: Internet stays on when the app is closed.',
    modalPacQrHint: 'Scan this QR with your phone; on the setup page tap "Copy" and paste in Wi-Fi → Proxy → Automatic.',
